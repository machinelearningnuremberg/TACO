...
from taco.model.tabpfn_arch.kdi_transformer import (
    KDITransformerWithNaN,
    get_all_kdi_transformers,
)
from taco.model.tabpfn_arch.utils import infer_random_state
...
class AdaptiveQuantileTransformer(QuantileTransformer):
    ...
    def fit(
        ...
        # print("[qt] effective n_quantiles", self.n_quantiles)  # <-- HERE
                ...
                [
                    ...
                    (
                        ...
                        AdaptiveQuantileTransformer(
                            ...
                            n_quantiles = min(1000, max(2, num_examples // 10)),
    ...
    def get_all_preprocessors(
        ...
        all_preprocessors = {
            ...
            "quantile_uni_coarse": AdaptiveQuantileTransformer(
                ...
                n_quantiles=min(2000, max(num_examples // 10, 2)),
                random_state=random_state,
            ),
