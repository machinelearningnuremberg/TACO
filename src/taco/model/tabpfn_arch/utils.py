...
from taco.model.tabpfn_arch.misc._sklearn_compat import check_array, validate_data
...
if TYPE_CHECKING:
    ...
    from taco.model.tabpfn_arch.classifier import TabPFNClassifier, XType, YType
